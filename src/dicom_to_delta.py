...
@click.option("-a", "--dataset_address", required=True, help=" path to dataset directory containing parquet, tables, and dicom directories, as well as dataset yaml file containing dataset metadata")
...
def cli(spark, driver, hdfs ,dataset_address, fs, merge, purge):
	"""
